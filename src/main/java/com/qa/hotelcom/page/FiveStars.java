...
public class FiveStars {
	...
	public FiveStars(WebDriver driver) {
		this.driver = driver;
		eUtil = new ElementUtil(driver);
		wait = new WebDriverWait(driver, 10);
	}

	By star = By.xpath("//input[@id='f-star-rating-5']");
	...
	public void getPageTitle(String expectedTitle) {
		...
		System.out.println("FiveStarhotelsPage Title is : \n" + title);
		try {
	...
	public void fiveStarHotelsandDistance() {
